...
type isFilterMatcher interface {
	isFilterMatcher()
}

func buildProtoNoFilter() *persistent.CreateReq_AllOptions_NoFilter {
	return &persistent.CreateReq_AllOptions_NoFilter{
		NoFilter: &shared.Empty{},
	}
}

func buildProtoFilter(filter Filter) *persistent.CreateReq_AllOptions_Filter {
	result := &persistent.CreateReq_AllOptions_Filter{
	...
	case FilterByEventType:
		...
		result.Filter.Filter = &persistent.CreateReq_AllOptions_FilterOptions_EventType{
	...
	case FilterByStreamId:
		...
		result.Filter.Filter = &persistent.CreateReq_AllOptions_FilterOptions_StreamIdentifier{
	...
	case FilterWindowMax:
		...
		result.Filter.Window = &persistent.CreateReq_AllOptions_FilterOptions_Max{
			Max: maxWindow.Max,
		}

	case FilterNoWindow:
		result.Filter.Window = &persistent.CreateReq_AllOptions_FilterOptions_Count{
			Count: &shared.Empty{},
		}
	}
