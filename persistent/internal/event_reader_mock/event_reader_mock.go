...
func (m *MockEventReader) Ack(msgs ...persistent_event.ReadResponseEvent) errors.Error {
	m.ctrl.T.Helper()
	varargs := []interface{}{}
	for _, a := range msgs {
...
func (m *MockEventReader) Nack(reason string, action persistent_action.Nack_Action, msgs ...persistent_event.ReadResponseEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockEventReader) ReadOne() (persistent_event.ReadResponseEvent, errors.Error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReadOne")
	ret0, _ := ret[0].(persistent_event.ReadResponseEvent)
